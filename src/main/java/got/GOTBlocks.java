...
public final class GOTBlocks {
    ...
    public static final RegistryObject<Block> COMMAND_TABLE = registerUtilityBlock("command_table", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).strength(2.5F)));
    public static final RegistryObject<Block> ALLOY_FORGE = registerUtilityBlock("alloy_forge", () -> new UtilityFacingBlock(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS).strength(3.5F).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> MILLSTONE = registerUtilityBlock("millstone", () -> new StonecutterBlock(BlockBehaviour.Properties.copy(Blocks.STONECUTTER).strength(3.5F).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> TABLE_ARRYN = registerUtilityBlock("table_arryn", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_ASSHAI = registerUtilityBlock("table_asshai", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_BRAAVOS = registerUtilityBlock("table_braavos", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_CROWNLANDS = registerUtilityBlock("table_crownlands", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_DORNE = registerUtilityBlock("table_dorne", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_DOTHRAKI = registerUtilityBlock("table_dothraki", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_DRAGONSTONE = registerUtilityBlock("table_dragonstone", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_GHISCAR = registerUtilityBlock("table_ghiscar", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_GIFT = registerUtilityBlock("table_gift", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_HILL_TRIBES = registerUtilityBlock("table_hill_tribes", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_IBBEN = registerUtilityBlock("table_ibben", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_IRONBORN = registerUtilityBlock("table_ironborn", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_JOGOS_NHAI = registerUtilityBlock("table_jogos_nhai", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_LHAZAR = registerUtilityBlock("table_lhazar", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_LORATH = registerUtilityBlock("table_lorath", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_LYS = registerUtilityBlock("table_lys", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_MOSSOVY = registerUtilityBlock("table_mossovy", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_MYR = registerUtilityBlock("table_myr", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_NORTH = registerUtilityBlock("table_north", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_NORVOS = registerUtilityBlock("table_norvos", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_PENTOS = registerUtilityBlock("table_pentos", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_QARTH = registerUtilityBlock("table_qarth", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_QOHOR = registerUtilityBlock("table_qohor", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_REACH = registerUtilityBlock("table_reach", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_RIVERLANDS = registerUtilityBlock("table_riverlands", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_SOTHORYOS = registerUtilityBlock("table_sothoryos", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_STORMLANDS = registerUtilityBlock("table_stormlands", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_SUMMER = registerUtilityBlock("table_summer", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_TYROSH = registerUtilityBlock("table_tyrosh", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_VOLANTIS = registerUtilityBlock("table_volantis", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_WESTERLANDS = registerUtilityBlock("table_westerlands", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_WILDLING = registerUtilityBlock("table_wildling", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistryObject<Block> TABLE_YI_TI = registerUtilityBlock("table_yi_ti", () -> new CraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
