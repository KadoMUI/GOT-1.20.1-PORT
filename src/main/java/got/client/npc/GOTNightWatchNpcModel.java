...
/** Original GOT human body geometry shared by ordinary and named Night's Watch NPCs. */
public final class GOTNightWatchNpcModel extends HumanoidModel<GOTNightWatchNpcEntity> {
    private final ModelPart chest;

    public GOTNightWatchNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("night_watch_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("night_watch_chest",
    ...
    @Override
    public void setupAnim(GOTNightWatchNpcEntity entity, float limbSwing, float limbSwingAmount,
