...
/** Original GOT humanoid geometry used by White Walkers, Wights, and the Night King. */
public final class GOTWhiteWalkerNpcModel extends HumanoidModel<GOTWhiteWalkerNpcEntity> {
    private final ModelPart chest;

    public GOTWhiteWalkerNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("white_walker_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("white_walker_chest",
    ...
    @Override
    public void setupAnim(GOTWhiteWalkerNpcEntity entity, float limbSwing, float limbSwingAmount,
