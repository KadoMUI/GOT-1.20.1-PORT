...
/** Original GOT human body geometry used by Lhazarish NPCs. */
public final class GOTLhazarNpcModel extends HumanoidModel<GOTLhazarNpcEntity> {
    private final ModelPart chest;

    public GOTLhazarNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("lhazar_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("lhazar_chest",
    ...
    @Override
    public void setupAnim(GOTLhazarNpcEntity entity, float limbSwing, float limbSwingAmount,
