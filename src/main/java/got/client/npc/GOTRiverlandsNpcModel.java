...
public final class GOTRiverlandsNpcModel extends HumanoidModel<GOTRiverlandsNpcEntity> {
    private final ModelPart chest;

    public GOTRiverlandsNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("riverlands_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("riverlands_chest",
    ...
    @Override
    public void setupAnim(GOTRiverlandsNpcEntity entity, float limbSwing, float limbSwingAmount,
