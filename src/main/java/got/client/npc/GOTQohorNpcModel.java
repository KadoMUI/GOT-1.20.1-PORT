...
/** Original GOT human body geometry used by Qohorish NPCs. */
public final class GOTQohorNpcModel extends HumanoidModel<GOTQohorNpcEntity> {
    private final ModelPart chest;

    public GOTQohorNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("qohor_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("qohor_chest",
    ...
    @Override
    public void setupAnim(GOTQohorNpcEntity entity, float limbSwing, float limbSwingAmount,
