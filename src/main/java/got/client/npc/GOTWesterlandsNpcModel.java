...
public final class GOTWesterlandsNpcModel extends HumanoidModel<GOTWesterlandsNpcEntity> {
    private final ModelPart chest;

    public GOTWesterlandsNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("westerlands_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("westerlands_chest",
    ...
    @Override
    public void setupAnim(GOTWesterlandsNpcEntity entity, float limbSwing, float limbSwingAmount,
