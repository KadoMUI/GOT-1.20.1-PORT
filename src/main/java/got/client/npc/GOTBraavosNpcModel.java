...
/** Original GOT human body geometry used by Braavosi NPCs. */
public final class GOTBraavosNpcModel extends HumanoidModel<GOTBraavosNpcEntity> {
    private final ModelPart chest;

    public GOTBraavosNpcModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(GOTBraavosNpcEntity entity, float limbSwing, float limbSwingAmount,
