...
/** Original GOT human body geometry used by Norvosish NPCs. */
public final class GOTNorvosNpcModel extends HumanoidModel<GOTNorvosNpcEntity> {
    private final ModelPart chest;

    public GOTNorvosNpcModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("norvos_chest",
    ...
    @Override
    public void setupAnim(GOTNorvosNpcEntity entity, float limbSwing, float limbSwingAmount,
