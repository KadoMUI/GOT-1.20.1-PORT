...
/** Original GOT human body geometry used by Lorathish NPCs. */
public final class GOTLorathNpcModel extends HumanoidModel<GOTLorathNpcEntity> {
    private final ModelPart chest;

    public GOTLorathNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("lorath_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("lorath_chest",
    ...
    @Override
    public void setupAnim(GOTLorathNpcEntity entity, float limbSwing, float limbSwingAmount,
