...
/** Original GOT human body geometry used by Volantene NPCs. */
public final class GOTVolantisNpcModel extends HumanoidModel<GOTVolantisNpcEntity> {
    private final ModelPart chest;

    public GOTVolantisNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("volantis_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("volantis_chest",
    ...
    @Override
    public void setupAnim(GOTVolantisNpcEntity entity, float limbSwing, float limbSwingAmount,
