...
/** Original GOT human body geometry used by JogosNhaii NPCs. */
public final class GOTJogosNhaiNpcModel extends HumanoidModel<GOTJogosNhaiNpcEntity> {
    private final ModelPart chest;

    public GOTJogosNhaiNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("jogos_nhai_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("jogos_nhai_chest",
    ...
    @Override
    public void setupAnim(GOTJogosNhaiNpcEntity entity, float limbSwing, float limbSwingAmount,
