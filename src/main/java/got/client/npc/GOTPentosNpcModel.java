...
/** Original GOT human body geometry used by Pentoshi NPCs. */
public final class GOTPentosNpcModel extends HumanoidModel<GOTPentosNpcEntity> {
    private final ModelPart chest;

    public GOTPentosNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("pentos_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("pentos_chest",
    ...
    @Override
    public void setupAnim(GOTPentosNpcEntity entity, float limbSwing, float limbSwingAmount,
