...
public final class GOTReachNpcModel extends HumanoidModel<GOTReachNpcEntity> {
    private final ModelPart chest;

    public GOTReachNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("reach_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("reach_chest",
    ...
    @Override
    public void setupAnim(GOTReachNpcEntity entity, float limbSwing, float limbSwingAmount,
