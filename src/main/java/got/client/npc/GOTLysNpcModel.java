...
/** Original GOT human body geometry used by Lysene NPCs. */
public final class GOTLysNpcModel extends HumanoidModel<GOTLysNpcEntity> {
    private final ModelPart chest;

    public GOTLysNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("lys_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("lys_chest",
    ...
    @Override
    public void setupAnim(GOTLysNpcEntity entity, float limbSwing, float limbSwingAmount,
