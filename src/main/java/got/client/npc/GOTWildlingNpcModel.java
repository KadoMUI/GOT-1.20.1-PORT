...
/** Original GOT human body geometry shared by ordinary and named Wildlings and Thenns. */
public final class GOTWildlingNpcModel extends HumanoidModel<GOTWildlingNpcEntity> {
    private final ModelPart chest;

    public GOTWildlingNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("wildling_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("wildling_chest",
    ...
    @Override
    public void setupAnim(GOTWildlingNpcEntity entity, float limbSwing, float limbSwingAmount,
