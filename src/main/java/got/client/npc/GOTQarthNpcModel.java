...
/** Original GOT human body geometry used by Qarthish NPCs. */
public final class GOTQarthNpcModel extends HumanoidModel<GOTQarthNpcEntity> {
    private final ModelPart chest;

    public GOTQarthNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("qarth_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("qarth_chest",
    ...
    @Override
    public void setupAnim(GOTQarthNpcEntity entity, float limbSwing, float limbSwingAmount,
