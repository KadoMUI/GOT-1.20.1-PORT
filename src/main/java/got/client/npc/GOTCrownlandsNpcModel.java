...
public final class GOTCrownlandsNpcModel extends HumanoidModel<GOTCrownlandsNpcEntity> {
    private final ModelPart chest;

    public GOTCrownlandsNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("crownlands_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("crownlands_chest",
    ...
    @Override
    public void setupAnim(GOTCrownlandsNpcEntity entity, float limbSwing, float limbSwingAmount,
