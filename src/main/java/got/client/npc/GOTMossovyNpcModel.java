...
/** Original GOT human body geometry used by Mossovyish NPCs. */
public final class GOTMossovyNpcModel extends HumanoidModel<GOTMossovyNpcEntity> {
    private final ModelPart chest;

    public GOTMossovyNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("mossovy_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("mossovy_chest",
    ...
    @Override
    public void setupAnim(GOTMossovyNpcEntity entity, float limbSwing, float limbSwingAmount,
