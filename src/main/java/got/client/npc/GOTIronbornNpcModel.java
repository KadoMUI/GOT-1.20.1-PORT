...
public final class GOTIronbornNpcModel extends HumanoidModel<GOTIronbornNpcEntity> {
    private final ModelPart chest;

    public GOTIronbornNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("ironborn_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("ironborn_chest",
    ...
    @Override
    public void setupAnim(GOTIronbornNpcEntity entity, float limbSwing, float limbSwingAmount,
