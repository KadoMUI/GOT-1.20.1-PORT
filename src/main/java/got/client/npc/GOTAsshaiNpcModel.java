...
/** Original GOT human body geometry used by Asshaii NPCs. */
public final class GOTAsshaiNpcModel extends HumanoidModel<GOTAsshaiNpcEntity> {
    private final ModelPart chest;

    public GOTAsshaiNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("asshai_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("asshai_chest",
    ...
    @Override
    public void setupAnim(GOTAsshaiNpcEntity entity, float limbSwing, float limbSwingAmount,
