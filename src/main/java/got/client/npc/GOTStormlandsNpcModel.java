...
public final class GOTStormlandsNpcModel extends HumanoidModel<GOTStormlandsNpcEntity> {
    private final ModelPart chest;

    public GOTStormlandsNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("stormlands_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("stormlands_chest",
    ...
    @Override
    public void setupAnim(GOTStormlandsNpcEntity entity, float limbSwing, float limbSwingAmount,
