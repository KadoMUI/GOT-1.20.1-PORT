...
/** Original GOT human body geometry used by Ghiscari NPCs. */
public final class GOTGhiscarNpcModel extends HumanoidModel<GOTGhiscarNpcEntity> {
    private final ModelPart chest;

    public GOTGhiscarNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("ghiscar_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("ghiscar_chest",
    ...
    @Override
    public void setupAnim(GOTGhiscarNpcEntity entity, float limbSwing, float limbSwingAmount,
