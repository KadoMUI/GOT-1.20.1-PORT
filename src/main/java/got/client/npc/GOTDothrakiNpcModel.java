...
/** Original GOT human body geometry used by Dothrakii NPCs. */
public final class GOTDothrakiNpcModel extends HumanoidModel<GOTDothrakiNpcEntity> {
    private final ModelPart chest;

    public GOTDothrakiNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("dothraki_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("dothraki_chest",
    ...
    @Override
    public void setupAnim(GOTDothrakiNpcEntity entity, float limbSwing, float limbSwingAmount,
