...
/** Original GOT human body geometry used by Tyroshi NPCs. */
public final class GOTTyroshNpcModel extends HumanoidModel<GOTTyroshNpcEntity> {
    private final ModelPart chest;

    public GOTTyroshNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("tyrosh_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("tyrosh_chest",
    ...
    @Override
    public void setupAnim(GOTTyroshNpcEntity entity, float limbSwing, float limbSwingAmount,
