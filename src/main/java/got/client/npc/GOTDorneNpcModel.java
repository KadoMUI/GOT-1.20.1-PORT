...
public final class GOTDorneNpcModel extends HumanoidModel<GOTDorneNpcEntity> {
    private final ModelPart chest;

    public GOTDorneNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("dorne_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("dorne_chest",
    ...
    @Override
    public void setupAnim(GOTDorneNpcEntity entity, float limbSwing, float limbSwingAmount,
