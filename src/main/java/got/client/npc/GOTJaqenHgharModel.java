...
/** Jaqen uses the legacy Braavosi humanoid geometry with a correctly typed model. */
public final class GOTJaqenHgharModel extends HumanoidModel<GOTJaqenHgharEntity> {
    private final ModelPart chest;

    public GOTJaqenHgharModel(ModelPart root) {
        super(root);
        chest = body.getChild("braavos_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("braavos_chest",
    ...
    @Override
    public void setupAnim(GOTJaqenHgharEntity entity, float limbSwing, float limbSwingAmount,
