...
public final class GOTArrynNpcModel extends HumanoidModel<GOTArrynNpcEntity> {
    private final ModelPart chest;

    public GOTArrynNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("arryn_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("arryn_chest",
    ...
    @Override
    public void setupAnim(GOTArrynNpcEntity entity, float limbSwing, float limbSwingAmount,
