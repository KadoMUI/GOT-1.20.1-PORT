...
/** Original GOT human body geometry used by YiTii NPCs. */
public final class GOTYiTiNpcModel extends HumanoidModel<GOTYiTiNpcEntity> {
    private final ModelPart chest;

    public GOTYiTiNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("yi_ti_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("yi_ti_chest",
    ...
    @Override
    public void setupAnim(GOTYiTiNpcEntity entity, float limbSwing, float limbSwingAmount,
