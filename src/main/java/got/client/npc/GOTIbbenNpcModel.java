...
/** Original GOT human body geometry used by Ibbeni NPCs. */
public final class GOTIbbenNpcModel extends HumanoidModel<GOTIbbenNpcEntity> {
    private final ModelPart chest;

    public GOTIbbenNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("ibben_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("ibben_chest",
    ...
    @Override
    public void setupAnim(GOTIbbenNpcEntity entity, float limbSwing, float limbSwingAmount,
