...
/** Original GOT human body geometry used by Myrish NPCs. */
public final class GOTMyrNpcModel extends HumanoidModel<GOTMyrNpcEntity> {
    private final ModelPart chest;

    public GOTMyrNpcModel(ModelPart root) {
        super(root);
        chest = body.getChild("myr_chest");
    }
    ...
    public static LayerDefinition bodyLayer(float deformation) {
        ...
        root.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 32)
                ...
                PartPose.ZERO);
        root.getChild("body").addOrReplaceChild("myr_chest",
    ...
    @Override
    public void setupAnim(GOTMyrNpcEntity entity, float limbSwing, float limbSwingAmount,
