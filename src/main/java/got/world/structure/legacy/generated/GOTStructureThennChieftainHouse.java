...
public class GOTStructureThennChieftainHouse extends LegacyNorthernContext {

   protected GOTStructureThennChieftainHouse(NorthStructureBuilder builder) {
      super(builder, Style.WILDLING);
   }


   public static void place(NorthStructureBuilder builder, int variant) {
      GOTStructureThennChieftainHouse piece = new GOTStructureThennChieftainHouse(builder);
   ...
   public boolean generate(LegacyNorthernContext world, Random random, int i, int j, int k, int rotation) {
      ...
      this.placeWallBanner(world, 0, 5, -5, "banner_THENN", 2);
      this.placeWallBanner(world, -2, 5, -5, "banner_THENN", 2);
      this.placeWallBanner(world, 2, 5, -5, "banner_THENN", 2);
      ...
      this.placeWallBanner(world, -3, 3, 0, "banner_THENN", 1);
      this.setBlockAndMetadata(world, 2, 5, 0, vanilla("field_150478_aa"), 1);
      this.placeWallBanner(world, 3, 3, 0, "banner_THENN", 3);
      ...
      LegacyEntity chieftain = new LegacyEntity(world);
