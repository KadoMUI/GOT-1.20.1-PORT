...
public class GOTStructureWildlingHouse extends LegacyNorthernContext {

   protected GOTStructureWildlingHouse(NorthStructureBuilder builder) {
      super(builder, Style.WILDLING);
   }


   public static void place(NorthStructureBuilder builder, int variant) {
      GOTStructureWildlingHouse piece = new GOTStructureWildlingHouse(builder);
