...
public class GOTStructureNorthHillmanChieftainHouse extends LegacyNorthernContext {

   protected GOTStructureNorthHillmanChieftainHouse(NorthStructureBuilder builder) {
      super(builder, Style.NORTH);
      this.markerPrefix = "north_hillman_chieftain";
   }


   public static void place(NorthStructureBuilder builder, int variant) {
      GOTStructureNorthHillmanChieftainHouse piece = new GOTStructureNorthHillmanChieftainHouse(builder);
   ...
   public boolean generate(LegacyNorthernContext world, Random random, int i, int j, int k, int rotation) {
      ...
      this.placeWallBanner(world, 0, 5, -5, "banner_EDDARD", 2);
      this.placeWallBanner(world, -2, 5, -5, "banner_EDDARD", 2);
      this.placeWallBanner(world, 2, 5, -5, "banner_EDDARD", 2);
      ...
      this.placeWallBanner(world, 0, 4, 5, "banner_EDDARD", 2);
      ...
      this.placeWallBanner(world, -3, 3, 0, "banner_EDDARD", 1);
      this.setBlockAndMetadata(world, 2, 5, 0, vanilla("field_150478_aa"), 1);
      this.placeWallBanner(world, 3, 3, 0, "banner_EDDARD", 3);
