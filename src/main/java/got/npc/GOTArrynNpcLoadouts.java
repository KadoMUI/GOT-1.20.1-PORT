...
/** Equipment and trade pools translated from the original Arryn classes. */
final class GOTArrynNpcLoadouts {
    private GOTArrynNpcLoadouts() {}

    static void configure(GOTArrynNpcEntity npc) {
        ArrynNpcRole role = npc.getRole();
        npc.clearLoadout();
        switch (role) {
            case ARRYN_MAN -> npc.setCombatWeapon(stack("got:iron_dagger"));
            case ARRYN_LEVYMAN -> {
                npc.setCombatWeapon(randomIronWeapon(npc));
                leatherArmor(npc);
            }
            case ARRYN_LEVYMAN_ARCHER -> {
            ...
            case YOHN_ROYCE -> {
                npc.setCombatWeapon(stack("got:lamentation"));
                bronzeRoyceArmor(npc);
            }
            case ROBIN_ARRYN, LYSA_ARRYN -> { }
            default -> {
    ...
    static MerchantOffers createOffers(ArrynNpcRole role) {
    ...
    private static void arrynArmor(GOTArrynNpcEntity npc, boolean helmet) {
        npc.setItemSlot(EquipmentSlot.FEET, stack("got:arryn_boots"));
        npc.setItemSlot(EquipmentSlot.LEGS, stack("got:arryn_leggings"));
        npc.setItemSlot(EquipmentSlot.CHEST, stack("got:arryn_chestplate"));
        if (helmet) npc.setItemSlot(EquipmentSlot.HEAD, stack("got:arryn_helmet"));
    }

    private static void arrynGuardArmor(GOTArrynNpcEntity npc) {
        npc.setItemSlot(EquipmentSlot.FEET, stack("got:arrynguard_boots"));
        npc.setItemSlot(EquipmentSlot.LEGS, stack("got:arrynguard_leggings"));
        npc.setItemSlot(EquipmentSlot.CHEST, stack("got:arrynguard_chestplate"));
        npc.setItemSlot(EquipmentSlot.HEAD, stack("got:arrynguard_helmet"));
    }

    private static void bronzeRoyceArmor(GOTArrynNpcEntity npc) {
        npc.setItemSlot(EquipmentSlot.FEET, stack("got:bronze_chainmail_boots"));
        ...
        npc.setItemSlot(EquipmentSlot.HEAD, stack("got:bronze_chainmail_helmet"));
    }

    private static void leatherArmor(GOTArrynNpcEntity npc) {
